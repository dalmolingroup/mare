...
Por volta de 99% das *reads* foram mantidas em todas as amostras - uma retenção alta e adequada pra fazer uma caracterização profunda do microbioma.
...
Utilizando um banco de dados reduzido do Kraken2 para observar a taxa de classificação, observamos que por volta de 70-80% das *reads* resultaram em nenhuma classificação, o que é esperado dado a profundidade do sequenciamento.
...
Após montagem com o MEGAHIT, observamos que a maioria dos *contigs* possuem um comprimento de até 1000 pares de base.
...
Após uma abordagem híbrida de binning utilizando os softwares MaxBin, CONCOCT e MetaBAT2, seguida de refinamento com o DASTool, pudemos obter inicialmente **1355 *bins*, que foram refinados para 112 *metagenome-assembled genomes* (MAGs)**.
...
Apesar de ainda não termos realizado a classificação taxonômica propriamente dita dessas bins, realizamos um passo de predição de sequências eucarióticas, procarióticas e de archaea com o software Tiara, mostrando que quase todas as MAGs obtidas são procarióticas.
